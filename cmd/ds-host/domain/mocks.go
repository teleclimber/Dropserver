...
func (m *MockMigrationJobModel) GetJob(arg0 int) (*MigrationJob, Error) {
	m.ctrl.T.Helper()
...
func (m *MockMigrationJobModel) SetFinished(arg0 int, arg1 nulltypes.NullString) Error {
	m.ctrl.T.Helper()
...
func (m *MockMigrationJobModel) SetStarted(arg0 int) (bool, Error) {
	m.ctrl.T.Helper()
