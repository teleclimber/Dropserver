...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/domain (interfaces: DBManagerI,MetricsI,SandboxI,SandboxManagerI,RouteHandler,CookieModel,SettingsModel,UserModel,UserInvitationModel,AppFilesModel,AppModel,AppspaceModel,Authenticator,Validator,Views,DbConn,AppspaceMetaDB,AppspaceInfoModels,AppspaceInfoModel,RouteModelV0,AppspaceRouteModels,StdInput,MigrationJobModel,MigrationJobController)
...
func (m *MockAppModel) CreateVersion(arg0 AppID, arg1 Version, arg2 int, arg3 string) (*AppVersion, Error) {
	m.ctrl.T.Helper()
...
func (m *MockAppModel) DeleteVersion(arg0 AppID, arg1 Version) Error {
	m.ctrl.T.Helper()
...
func (m *MockAppspaceModel) GetForApp(arg0 AppID) ([]*Appspace, Error) {
	m.ctrl.T.Helper()
...
func (m *MockAppspaceModel) SetVersion(arg0 AppspaceID, arg1 Version) Error {
	m.ctrl.T.Helper()
...
// Get mocks base method
func (m *MockAppspaceInfoModels) Get(arg0 AppspaceID) AppspaceInfoModel {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(AppspaceInfoModel)
	return ret0
}
...
func (m *MockMigrationJobController) SubscribeOwner(arg0 UserID, arg1 string) (<-chan MigrationStatusData, []MigrationStatusData) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeOwner", arg0, arg1)
	ret0, _ := ret[0].(<-chan MigrationStatusData)
	ret1, _ := ret[1].([]MigrationStatusData)
	return ret0, ret1
}
...
func (m *MockMigrationJobController) UnsubscribeOwner(arg0 UserID, arg1 string) {
	m.ctrl.T.Helper()
