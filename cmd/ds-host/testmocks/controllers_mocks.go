...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/testmocks (interfaces: SetupKey,RemoteAppGetter,DeleteApp,BackupAppspace,RestoreAppspace,MigrationJobController,AppspaceStatus,AppspaceTSNet,AppspaceRouter)
...
// MockAppspaceTSNet is a mock of AppspaceTSNet interface
type MockAppspaceTSNet struct {
	ctrl     *gomock.Controller
	recorder *MockAppspaceTSNetMockRecorder
}

// MockAppspaceTSNetMockRecorder is the mock recorder for MockAppspaceTSNet
type MockAppspaceTSNetMockRecorder struct {
	mock *MockAppspaceTSNet
}

// NewMockAppspaceTSNet creates a new mock instance
func NewMockAppspaceTSNet(ctrl *gomock.Controller) *MockAppspaceTSNet {
	mock := &MockAppspaceTSNet{ctrl: ctrl}
	mock.recorder = &MockAppspaceTSNetMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockAppspaceTSNet) EXPECT() *MockAppspaceTSNetMockRecorder {
	return m.recorder
}
...
func (m *MockAppspaceTSNet) GetStatus(arg0 domain.AppspaceID) domain.TSNetAppspaceStatus {
	...
	ret0, _ := ret[0].(domain.TSNetAppspaceStatus)
	return ret0
}
