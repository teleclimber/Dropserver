...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/testmocks (interfaces: AppModel,AppspaceModel,AppspaceInfoModels,AppspaceUserModel,MigrationJobModel)
...
func (m *MockAppspaceUserModel) GetByProxy(arg0 domain.AppspaceID, arg1 domain.ProxyID) (domain.AppspaceUser, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAppspaceUserModelMockRecorder) GetByProxy(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByProxy", reflect.TypeOf((*MockAppspaceUserModel)(nil).GetByProxy), arg0, arg1)
}
