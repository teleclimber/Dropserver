...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/testmocks (interfaces: UserModel,SettingsModel,AppFilesModel,AppModel,AppspaceModel,AppspaceFilesModel,AppspaceInfoModels,AppspaceContactModel,DropIDModel,MigrationJobModel)
