...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/testmocks (interfaces: AppspaceMetaDB,AppspaceInfoModel,UsersV0,AppspaceDB,AppspaceLogger)
...
type MockAppspaceDB struct {
	ctrl     *gomock.Controller
	recorder *MockAppspaceDBMockRecorder
}
...
func NewMockAppspaceDB(ctrl *gomock.Controller) *MockAppspaceDB {
	mock := &MockAppspaceDB{ctrl: ctrl}
	mock.recorder = &MockAppspaceDBMockRecorder{mock}
	return mock
}
...
func (m *MockAppspaceDB) CloseAppspace(arg0 domain.AppspaceID) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CloseAppspace", arg0)
}
...
func (mr *MockAppspaceDBMockRecorder) CloseAppspace(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseAppspace", reflect.TypeOf((*MockAppspaceDB)(nil).CloseAppspace), arg0)
}
...
// EjectLogger mocks base method
func (m *MockAppspaceLogger) EjectLogger(arg0 domain.AppspaceID) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "EjectLogger", arg0)
}

// EjectLogger indicates an expected call of EjectLogger
func (mr *MockAppspaceLoggerMockRecorder) EjectLogger(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EjectLogger", reflect.TypeOf((*MockAppspaceLogger)(nil).EjectLogger), arg0)
}
