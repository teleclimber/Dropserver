...
// Source: github.com/teleclimber/DropServer/cmd/ds-host/testmocks (interfaces: AppspaceFilesEvents,AppspaceTSNetModelEvents,AppUrlDataEvents,AppspaceStatusEvents,InstanceUserAuthsChangeEvents,AppspaceUsersChangeEvents,UserAppspacesEvent,AppspaceUsersEvent)
...
// MockAppspaceUsersEvent is a mock of AppspaceUsersEvent interface
type MockAppspaceUsersEvent struct {
	ctrl     *gomock.Controller
	recorder *MockAppspaceUsersEventMockRecorder
}

// MockAppspaceUsersEventMockRecorder is the mock recorder for MockAppspaceUsersEvent
type MockAppspaceUsersEventMockRecorder struct {
	mock *MockAppspaceUsersEvent
}

// NewMockAppspaceUsersEvent creates a new mock instance
func NewMockAppspaceUsersEvent(ctrl *gomock.Controller) *MockAppspaceUsersEvent {
	mock := &MockAppspaceUsersEvent{ctrl: ctrl}
	mock.recorder = &MockAppspaceUsersEventMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockAppspaceUsersEvent) EXPECT() *MockAppspaceUsersEventMockRecorder {
	return m.recorder
}

// Send mocks base method
func (m *MockAppspaceUsersEvent) Send(arg0 domain.AppspaceID) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Send", arg0)
}

// Send indicates an expected call of Send
func (mr *MockAppspaceUsersEventMockRecorder) Send(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockAppspaceUsersEvent)(nil).Send), arg0)
}
