...
<template>
	<div class="flex flex-col border-2 p-1 border-gray-500 rounded-lg text-sm">
		<div class="mb-1 flex justify-center items-center rounded-sm" 
		...
		<div class="flex items-stretch">
			<UiButton class="mr-1 flex justify-center items-center grow" :pressed="ui_inspect_sandbox" @click.stop.prevent="toggleInspect">
			...
			<UiButton class="flex justify-center items-center grow" type="submit" @click.stop.prevent="stopSandbox()" :disabled="!type">
